...
-- ── Tajir Journal Entries (Voucher Header) ────────────────────
CREATE TABLE "tajir_journal_entries" (
  ...
  "source_id"      uuid,
  "created_at"     timestamp with time zone DEFAULT now() NOT NULL,
  CONSTRAINT "uq_tajir_journal_entries_tenant_voucher" UNIQUE("tenant_id", "voucher_number")
);

-- ── Tajir Journal Entry Lines (Debit / Credit) ────────────────
...
-- ── Atomic voucher number function ───────────────────────────
...
-- ── Pakistani Standard CoA seed function ─────────────────────
