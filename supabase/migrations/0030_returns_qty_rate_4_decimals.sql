-- Widen quantity & rate on purchase_returns and sale_returns from 3/2 to 4 decimal places.
...
ALTER TABLE purchase_returns ALTER COLUMN quantity TYPE numeric(15,4);
ALTER TABLE purchase_returns ALTER COLUMN rate     TYPE numeric(15,4);
ALTER TABLE sale_returns     ALTER COLUMN quantity TYPE numeric(15,4);
ALTER TABLE sale_returns     ALTER COLUMN rate     TYPE numeric(15,4);
