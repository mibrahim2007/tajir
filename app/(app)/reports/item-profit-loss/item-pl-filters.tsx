...
type Props = { lots: { id: string; name: string }[] }

export function ItemPLFilters({ lots }: Props) {
  ...
  return (
    <div className="flex flex-wrap gap-2 mb-4">
      ...
      >
        <SelectTrigger className="w-64 min-h-[44px]"><SelectValue placeholder="Select stock item…" /></SelectTrigger>
        <SelectContent>
